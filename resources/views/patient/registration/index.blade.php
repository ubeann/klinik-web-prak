  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Jadwal Temu</li>
          </ol>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-right pb-2 mb-3 border-bottom float-right">
        <div class="btn-toolbar mb-0 btn text-right">
          <div class="btn-group me-2 float-right"><a href="{{ route('patient.dashboard.registration.create') }}" class="btn btn-primary mb-3 btn text-right">Buat Jadwal Temu</a></div>
        </div>
    </div>
  </main>
