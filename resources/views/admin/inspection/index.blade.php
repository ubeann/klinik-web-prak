  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                    ...
                    @forelse ($inspections as $inspection)
                        <tr>
                            ...
                            <td class="text-center text-sm font-weight-bold">
                                ...
                                <a href="{{ route('admin.inspection.delete', $inspection->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-right pt-3 pb-2 mb-3 border-bottom float-right">
      <div class="btn-toolbar mb-0 btn text-right mt-2">
        <div class="btn-group me-2 float-right"><a href="{{ route('admin.inspection.create') }}" class="btn btn-primary mb-3 btn text-right">Add Pemeriksaan</a></div>
      </div>
    </div>
  </main>
