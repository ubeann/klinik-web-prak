          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Edit Pemeriksaan</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <div class="col-lg-8 table align-items-center mb-0">
                    <form method="POST" action="{{ route('admin.inspection.update', $inspection->id) }}">
                        @csrf
                        <div class="mb-3">
                            <label for="registration_id">Pilih Pendaftaran <span class="text-danger">(Tidak Bisa Diubah)</span></label>
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3">
                                    <select name="registration_id" id="registration_id" class="form-control">
                                        <option value="{{ $inspection->registration->id }}" selected disabled>{{ $inspection->registration->arrival_date }} - Pasien({{ $inspection->registration->patient->name }}) : Dokter({{ $inspection->registration->doctor->name }})</option>
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3 px-2">
                                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') ?? $inspection->service->name }}">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3 px-2">
                                    <input type="text" name="type" id="type" class="form-control" value="{{ old('type') ?? $inspection->type }}">
                                    @error('type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="mb-3">
                            <label for="price">Tarif Pemeriksaan</label>
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3 px-2">
                                    <input type="number" name="price" id="price" class="form-control" value="{{ old('price') ?? $inspection->price }}">
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
