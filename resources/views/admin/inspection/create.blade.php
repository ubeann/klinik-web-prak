              ...
              <div class="table-responsive p-0">
                <div class="col-lg-8 table align-items-center mb-0">
                    <form method="POST" action="{{ route('admin.inspection.store') }}">
                        @csrf
                        <div class="mb-3">
                            <label for="registration_id">Pilih Pendaftaran</label>
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3">
                                    <select name="registration_id" id="registration_id" class="form-control">
                                        @forelse ($registrations as $registration)
                                            <option value="{{ $registration->id }}">{{ $registration->arrival_date }} - Pasien({{ $registration->patient->name }}) : Dokter({{ $registration->doctor->name }})</option>
                                        @empty
                        ...
                        <div class="mb-3">
                            <label for="price">Tarif Pemeriksaan (Rp)</label>
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3 px-2">
