...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID Dokter</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">No SIP</th>
                  ...
                  <tbody>
                    @forelse ($doctors as $doctor)
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs text-secondary mb-0">{{ $doctor->name }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs text-secondary mb-0">{{ $doctor->birth_date }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs text-secondary mb-0">{{ $doctor->number_SIP }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs text-secondary mb-0">{{ $doctor->specialization }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs text-secondary mb-0">{{ $doctor->address_card }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs text-secondary mb-0">{{ $doctor->number_phone }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <a href="{{ route('admin.doctor.edit', $doctor->id) }}" class="badge bg-warning md-18">
                                <div class="text-white text-center d-flex align-items-center justify-content-center">
                                    <span class="material-icons md-18">edit</span>
                                </div>
                                </a>
                                <a href="{{ route('admin.doctor.delete', $doctor->id) }}" class="badge bg-danger" onclick="return confirm('Are you sure?')" >
                                <div class="text-white text-center d-flex align-items-center justify-content-center">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-right pb-2 mb-3 border-bottom float-right">
      <div class="btn-toolbar mb-0 btn text-right">
        <div class="btn-group me-2 float-right"><a href="{{ route('admin.doctor.create') }}" class="btn btn-primary mb-3 btn text-right">Add Dokter</a></div>
      </div>
    </div>
  </main>
