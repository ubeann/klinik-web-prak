    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                <a href="{{ route('admin.doctor.delete', $doctor->id) }}"
                                                    class="badge bg-danger" onclick="return confirm('Are you sure?')">
                                                    <div
                                                        class="text-white text-center d-flex align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-right pb-2 mb-3 float-right">
            <div class="btn-toolbar mb-0 btn text-right">
                <div class="btn-group me-2 float-right"><a href="{{ route('admin.doctor.create') }}"
                        class="btn btn-info mb-3 btn text-right">Add Dokter</a></div>
            </div>
        </div>
    </main>
    <!--   Core JS Files   -->
