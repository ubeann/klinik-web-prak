                    ...
                    <div class="mb-3">
                        ...
                        <div class="ms-md-auto">
                          <div class="input-group input-group-outline mb-3">
                              <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" type="text" value="{{ old('name') ?? $doctor->name }}" required autocomplete="name">
                                @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                              <div class="input-group input-group-outline">
                                    <input class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" type="date" name="birth_date" value="{{ old('birth_date') ?? strftime('%Y-%m-%d', strtotime($doctor->birth_date)) }}" required autocomplete="birth_date">
                                    @error('birth_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="mb-3">
                              ...
                              <div class="ms-md-auto">
                                  <div class="input-group input-group-outline">
                                      <input class="form-control @error('number_SIP') is-invalid @enderror" id="number_SIP" type="number" name="number_SIP" value="{{ old('number_SIP') ?? $doctor->number_SIP }}" autocomplete="number_SIP">
                                      @error('number_SIP')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                            ...
                            <div class="mb-3">
                              ...
                              <div class="ms-md-auto">
                                  <div class="input-group input-group-outline mb-3">
                                      <input class="form-control @error('specialization') is-invalid @enderror" id="specialization" type="text" name="specialization" value="{{ old('specialization') ?? $doctor->specialization }}" autocomplete="specialization">
                            ...
                            <div class="ms-md-auto">
                              <div class="input-group input-group-outline">
                                  <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" autocomplete="address" rows="3">{{ old('address') ?? $doctor->address }}</textarea>
                                  @error('address')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                              <div class="input-group input-group-outline">
                                  <input class="form-control @error('number_phone') is-invalid @enderror" id="number_phone" type="text" name="number_phone" value="{{ old('number_phone') ?? $doctor->number_phone }}" autocomplete="number_phone">
                                  @error('number_phone')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
