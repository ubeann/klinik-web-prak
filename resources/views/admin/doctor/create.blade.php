...
<body class="g-sidenav-show bg-gray-200 dark-version">
  @include('admin.component.sidebarAdmin', ['title' => 'Dokter'])
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline">
                                    <input class="form-control text-white @error('number_SIP') is-invalid @enderror" id="number_SIP" type="number" name="number_SIP" value="{{ old('number_SIP') }}" autocomplete="number_SIP">
                                    @error('number_SIP')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3">
                                    <input class="form-control text-white @error('specialization') is-invalid @enderror" id="specialization" type="text" name="specialization" value="{{ old('specialization') }}" autocomplete="specialization">
                      ...
                      <div>
                          <div class="mb-3 px-3">
                              <button type="submit" class="btn btn-info">Add Dokter</button>
                          </div>
                      </div>
                  </form>
                  </div>
