          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Add Dokter</h6>
              </div>
            </div>
                  ...
                  <form method="POST" action="{{ route('admin.doctor.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                          ...
                          <div class="ms-md-auto">
                            <div class="input-group input-group-outline">
                                <input class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" type="date" name="birth_date" value="{{ old('birth_date') }}" autocomplete="birth_date">
                                @error('birth_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline">
                                    <input class="form-control @error('number_SIP') is-invalid @enderror" id="number_SIP" type="number" name="number_SIP" value="{{ old('number_SIP') }}" autocomplete="number_SIP">
                                    @error('number_SIP')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="ms-md-auto">
                                <div class="input-group input-group-outline mb-3">
                                    <input class="form-control @error('specialization') is-invalid @enderror" id="specialization" type="text" name="specialization" value="{{ old('specialization') }}" autocomplete="specialization">
                          ...
                          <div class="ms-md-auto">
                            <div class="input-group input-group-outline">
                                <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" autocomplete="address" rows="3">{{ old('address') }}</textarea>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                      ...
                      <div class="mb-3">
                          ...
                          <div class="ms-md-auto">
                            <div class="input-group input-group-outline">
                                <input class="form-control @error('number_phone') is-invalid @enderror" id="number_phone" type="text" name="number_phone" value="{{ old('number_phone') }}" autocomplete="number_phone">
                                @error('number_phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
