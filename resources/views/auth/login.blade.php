          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto {{-- me-lg-5 --}}">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form action="{{ $type === 'patient' ? route('patient.login.submit') : route('admin.login.submit') }}" method="post" role="form">
                    @csrf
                    <div class="input-group input-group-outline mb-3">
                        <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                          @error('email')
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    <p class="mb-2 text-sm mx-auto">
                        ...
                        <a href="{{ route('patient.register.form') }}" class="text-primary text-gradient font-weight-bold">Sign Up</a>
                    </p>
                  </div>
              </div>
            </div>
